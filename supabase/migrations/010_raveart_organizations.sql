...
CROSS JOIN (
  VALUES
    ...
    (
      'raveart-summer-2026',
      'Raveart Summer 2026',
      'Public ticketing is already open for Summer 2026 on Raveart''s official site, although the detailed lineup, venue and schedule have not yet been published. This row keeps the database ready for the next update.',
      'La venta publica para Summer 2026 ya aparece activa en la web oficial de Raveart, aunque el lineup detallado, el recinto y los horarios aun no se han publicado. Esta fila deja la base preparada para la siguiente actualizacion.',
      'upcoming',
      NULL::DATE,
      NULL::DATE,
      'Andalusia',
