...
const ACTIONS = [
  ...
  {
    id: 'events-patch-heat-opening-special-360-show-2026',
    run: 'node scripts/guia-base-datos.mjs run events-patch-heat-opening-special-360-show-2026',
...
function main() {
  ...
  switch (sub) {
    ...
    case 'events-patch-break-nation-by-420-sound-2026':
      ...
      break
    case 'events-patch-heat-opening-special-360-show-2026':
      runNode('enriquecer-evento.mjs', ['--patch-heat-opening-special-360-show-2026', ...rest])
      break
