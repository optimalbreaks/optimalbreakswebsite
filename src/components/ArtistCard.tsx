...
export default function ArtistCard({ num, name, genres, desc, href, imageUrl, entityId, lang }: ArtistCardProps) {
  const body = (
    <>
      ...
      <div className="flex flex-col p-4 sm:p-[22px_30px] flex-grow min-h-0">
        <div
  ...
  const shell =
    'border-b-[3px] sm:border-r-[3px] border-[var(--ink)] transition-all duration-150 hover:bg-[var(--yellow)] group min-w-0 flex flex-col h-full overflow-hidden'
